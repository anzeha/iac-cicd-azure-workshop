...
public sealed class EfProjectionRepository : IProjectionRepository
{
  private readonly IDbContextFactory<WorkshopDbContext> _dbContextFactory;

  public EfProjectionRepository(IDbContextFactory<WorkshopDbContext> dbContextFactory)
  {
  ...
  public async Task<bool> UpsertOrderIfEventNotProcessedAsync(
